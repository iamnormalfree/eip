...
COORDINATION_LOG_DIR="${PROJECT_ROOT}/.maf/logs/coordination"
DOCS_DIR="${PROJECT_ROOT}/docs/operations/agent-coordination"
SERVER_LOG="${PROJECT_ROOT}/.agent-mail/server.log"
