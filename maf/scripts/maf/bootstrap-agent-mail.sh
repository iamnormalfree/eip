...
# ABOUTME: Provides install|update|status|bootstrap-only commands with Python 3.12 compatibility handling.
...
## Dependencies
- Beads CLI v0.22.1+
- Python 3.12+ (3.10+ may work with compatibility mode)
