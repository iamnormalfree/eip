...
export enum AuthorityLevel {
  HIGH = 'high',     // Exact match to trusted domains
  MEDIUM = 'medium', // Wildcard match to government domains
  LOW = 'low'        // General pattern match
}
...
export class DomainValidator {
   ...
   */
  private buildRules(allowListDomains: string[], customRules?: DomainRule[]): void {
    this.rules = [];
   ...
   */
  private createRuleFromDomain(domain: string): DomainRule | null {
   ...
   */
  getRulesByAuthority(level: AuthorityLevel): DomainRule[] {
  ...
  getStats(): {
    totalRules: number;
    rulesByAuthority: Record<AuthorityLevel, number>;
    patterns: string[];
  } {
 ...
 */
export function createSingaporeDomainValidator(): DomainValidator {
 ...
 */
export function validateDomain(url: string, allowListDomains: string[]): ValidationResult {
