...
async function processConceptNodesTest(session: Session | null, supabase: SupabaseClient, since?: string, graphSparse?: boolean) {
  let created = 0;
  let processed = 0;
...
async function processPersonaNodesTest(session: Session | null, supabase: SupabaseClient, since?: string, graphSparse?: boolean) {
  let created = 0;
  let processed = 0;
...
async function processOfferNodesTest(session: Session | null, supabase: SupabaseClient, since?: string, graphSparse?: boolean) {
  let created = 0;
  let processed = 0;
...
async function processEvidenceNodesTest(session: Session | null, supabase: SupabaseClient, since?: string, graphSparse?: boolean) {
  let created = 0;
  let processed = 0;
...
async function processArtifactNodesTest(session: Session | null, supabase: SupabaseClient, since?: string, graphSparse?: boolean) {
  let created = 0;
  let processed = 0;
